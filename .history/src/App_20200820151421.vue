<template>
  <div id="app">
    <Head></Head>
    <Sidebar @circleShow="circleShow" @checkWd="handleCheckWd" @checkST="handlecheckST" @checkBankWD="handleheckBankWD"></Sidebar>
     <!-- <router-view/> -->
    <Map :bankCircleShow="bankCircleShow" :bussinessCenterShow="bussinessCenterShow" :stShow="stShow"></Map>
  </div>
</template>
