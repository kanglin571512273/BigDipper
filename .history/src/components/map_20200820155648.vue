    ...
    >
      ...
      <div v-if="bankCircleShow && bankWDShow">
        <bm-marker
          ...
          :key="index"
          :position="item"
          :icon="{url: 'https://ss0.bdstatic.com/70cFvHSh_Q1YnxGkpoWK1HF6hhy/it/u=3316254631,2645058249&fm=26&gp=0.jpg', size: {width: 20, height: 37}}"
          title="农业银行"
          @click="markerClick"
        >
        </bm-marker>
...
<script>
import abc_mid from '../assets/mark/abc_mid'
