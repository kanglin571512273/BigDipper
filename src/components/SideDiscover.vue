  ...
  data() {
    return {
      ...
      companylist: [
        ...
        { id: 85, label: "杭州朗珮科技有限公司", num: 350 },
        { id: 65, label: "杭州朗珮科技有限公司", num: 360 },
        { id: 165, label: "杭州朗珮科技有限公司", num: 430 },
        { id: 265, label: "杭州朗珮科技有限公司", num: 480 },
        { id: 365, label: "杭州朗珮科技有限公司", num: 570 },
        { id: 465, label: "杭州朗珮科技有限公司", num: 620 },
        { id: 565, label: "杭州朗珮科技有限公司", num: 870 },
      ],
      apartment: [
